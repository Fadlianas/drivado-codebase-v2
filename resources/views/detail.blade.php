    ...
    <div class="container py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb small text-uppercase fw-bold letter-spacing-1">
                <li class="breadcrumb-item"><a href="{{ url('/') }}" class="text-decoration-none text-secondary">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/search') }}" class="text-decoration-none text-secondary">Fleet</a></li>
        ...
        <div class="row g-5 mt-2">
            ...
            <div class="col-lg-8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-secondary lead"><i class="bi bi-geo-alt me-2"></i>Available at {{ $vehicle->agency->agency_name }}, {{ $vehicle->agency->city }}</p>
                    </div>
                    <div class="text-end d-none d-md-block">
                        ...
                        <p class="small fw-bold mb-0">TOP RATED</p>
                    </div>
                </div>
                ...
                <div class="row g-4 mb-5">
                    <div class="col-6 col-md-3">
                        <div class="card border-0 bg-white shadow-sm p-4 text-center rounded-4 h-100">
                            ...
                            <p class="fw-bold mb-0">Automatic</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card border-0 bg-white shadow-sm p-4 text-center rounded-4 h-100">
                            <i class="bi bi-people fs-2 mb-2"></i>
                            <p class="small text-secondary fw-bold text-uppercase mb-0">Capacity</p>
                            <p class="fw-bold mb-0">5 Seats</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card border-0 bg-white shadow-sm p-4 text-center rounded-4 h-100">
                            <i class="bi bi-fuel-pump fs-2 mb-2"></i>
                            <p class="small text-secondary fw-bold text-uppercase mb-0">Fuel Type</p>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card border-0 bg-white shadow-sm p-4 text-center rounded-4 h-100">
                            ...
                            <p class="small text-secondary fw-bold text-uppercase mb-0">Comfort</p>
                            <p class="fw-bold mb-0">Air Cond.</p>
                        </div>
                    </div>
                </div>

                <div class="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-5">
                    <h5 class="fw-bold mb-4">Vehicle Description</h5>
                    <p class="text-secondary mb-5 lead">{{ $vehicle->description }}</p>

                    <h5 class="fw-bold mb-4">Premium Features</h5>
                    <div class="row g-3">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg p-4 p-md-5 rounded-4 sticky-top" style="top: 120px; z-index: 10;">
                    <div class="d-flex justify-content-between align-items-end mb-4">
                        ...
                        <div class="text-end">
                            ...
                            <span class="text-secondary small">MAD/DAY</span>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('booking.checkout') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-dark w-100 py-3 fw-bold mb-3 shadow-lg">CONTINUE TO CHECKOUT</button>
                        
                        <div class="text-center">
                            <p class="small text-secondary mb-0"><i class="bi bi-shield-lock me-1"></i> Secure payment processed by Stripe</p>
                        </div>
                    </form>
                </div>
                ...
                <div class="card border-0 shadow-sm p-4 rounded-4 mt-4 bg-white">
                    <h6 class="fw-bold mb-3">Rental Agency</h6>
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="small text-secondary mb-0">Verified Agency</p>
                        </div>
                    </div>
                </div>
            </div>
